...
/* Private defines -----------------------------------------------------------*/
#define FSR_SEAT_Pin GPIO_PIN_0
#define FSR_SEAT_GPIO_Port GPIOC
...
#define RLY1_Pin GPIO_PIN_7
#define RLY1_GPIO_Port GPIOA
#define RLY2_Pin GPIO_PIN_4
...
#define FSR_WHEEL_Pin GPIO_PIN_6
#define FSR_WHEEL_GPIO_Port GPIOC
